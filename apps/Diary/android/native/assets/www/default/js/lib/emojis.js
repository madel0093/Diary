...
/* JavaScript content from js/lib/emojis.js in folder common */
$.emojiarea.path = 'images/packs/basic/images';
$.emojiarea.icons = [{
    "name": "<i class='icon-smile'></i>",
    "icons": {
        ':bowtie:': 'bowtie.png',
        ':smile:': 'smile.png',
